...
j = int(input('Введите номер который на самом деле имеет вагон: '))

res = i + j - 1
if(j == 0):
    print('Без дополнительной информации невозможно определить кол-во вагонов.')
else:
    print('Количество вагонов в поезде:', res)